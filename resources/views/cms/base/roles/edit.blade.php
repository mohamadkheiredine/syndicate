        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.'.$page_info['link'].'.update', $role) }}" autocomplete="off">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Name" value="{{ old('name', $role->name) }}" autofocus>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <label class="custom-toggle mb-0">
                                                <input type="checkbox" value="{{ $value->id }}" name="permission[]" @if(old('permission')) {{ in_array($value->id, old('permission')) ? 'checked' : '' }} @else {{ (isset($rolePermissions) && in_array($value->id, $rolePermissions)) ? 'checked' : '' }} @endif>
