                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            ...
                            <form method="POST" action="{{ route('admin.'.$page_info['link'].'.single') }}" enctype="multipart/form-data" autocomplete="off">
                                ...
                                {{-- Users --}}
                                @include('cms.components.inputs.select-multiple', ['label' => 'Users', 'asterix' => true, 'name' => 'users', 'rows' => $users, 'value_attribute' => 'id', 'multi_attributes' => 'full_name - mobile_number'])
