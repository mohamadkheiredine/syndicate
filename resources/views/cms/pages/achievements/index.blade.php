        ...
        <table class="table align-items-center table-flush">
            <thead class="thead-light">
                <tr>
                    ...
                    @include('cms.layouts.pagination.sort-col', ['col_name' => 'number', 'col_title' => 'Number'])
                ...
                <tr>
                    ...
                    <td class="adjust-element">
                        <label class="custom-toggle mb-0">
                            <input
                                @can('achievements-publish') onclick="togglePublish({{ $row->id }})" @else disabled @endcan
