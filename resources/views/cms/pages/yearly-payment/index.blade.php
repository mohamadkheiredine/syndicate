    ...
    <div class="card shadow mt-5">
        ...
        <table class="table align-items-center table-flush">
            <thead class="thead-light">
                <tr>
                    @include('cms.layouts.pagination.sort-col', ['col_name' => 'payment_year', 'col_title' => 'Year'])
                    @include('cms.layouts.pagination.sort-col', ['col_name' => 'payment_amount', 'col_title' => 'Amount'])
