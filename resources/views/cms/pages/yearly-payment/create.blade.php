    ...
    <div class="card bg-secondary shadow">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('admin.'.$page_info['link'].'.store') }}" autocomplete="off">
                ...
                {{-- Year --}}
                @include('cms.components.inputs.number', ['label' => 'Year', 'asterix' => true, 'name' => 'payment_year'])

                {{-- Amount --}}
                @include('cms.components.inputs.number', ['label' => 'Amount', 'asterix' => true, 'name' => 'payment_amount'])
