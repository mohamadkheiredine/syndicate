    ...
    <div class="card shadow mt-5">
        ...
        <table class="table align-items-center table-flush">
            <thead class="thead-light">
                <tr>
                    @include('cms.layouts.pagination.sort-col', ['col_name' => 'advertise_type', 'col_title' => 'Advertisement Type'])
                    @include('cms.layouts.pagination.sort-col', ['col_name' => 'title', 'col_title' => 'Title'])
                    <th scope="col" class="no-sort">Dimension</th>
                    <th scope="col" class="no-sort">Type</th>
                    <th scope="col" class="no-sort">Price</th>
                    <th scope="col" class="no-sort">Duration</th>
                ...
                <tr>
                    ...
                    <td class="adjust-element">
                        <label class="custom-toggle mb-0">
                            <input
                                @can('syndicate_advertisement-publish') onclick="togglePublish({{ $row->id }})" @else disabled @endcan
