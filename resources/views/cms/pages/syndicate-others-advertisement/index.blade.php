                ...
                <tr>
                    ...
                    <td class="adjust-element">
                        <label class="custom-toggle mb-0">
                            <input
                                @can('syndicate_others_advertisement-publish') onclick="togglePublish({{ $row->id }})" @else disabled @endcan
                    ...
                    <td class="text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                @can('syndicate_others_advertisement-edit')
                                <a class="dropdown-item" href="{{ route('admin.'.$page_info['link'].'.edit', $row) }}">Edit</a>
                                @endcan

                                @can('syndicate_others_advertisement-delete')
