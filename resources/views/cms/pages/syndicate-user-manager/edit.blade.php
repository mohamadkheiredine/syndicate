...
@section('content')
@include('cms.layouts.headers.partials', ['title' => 'Edit Syndicate User'])
...
<div class="container-fluid mt--7">
    <div class="card bg-secondary shadow">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('admin.'.$page_info['link'].'.update', $row->id) }}" enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('put')
