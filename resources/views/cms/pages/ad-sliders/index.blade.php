        ...
        <table class="table align-items-center table-flush">
            <thead class="thead-light">
                <tr>
                    ...
                    @include('cms.layouts.pagination.sort-col', ['col_name' => 'text', 'col_title' => 'Text'])
                ...
                <tr>
                    ...
                    <td class="adjust-element">
                        <label class="custom-toggle mb-0">
                            <input
                                @can('ad_sliders-publish') onclick="togglePublish({{ $row->id }})" @else disabled @endcan
